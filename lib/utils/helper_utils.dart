...
class HelperUtils {
  ...
  static dynamic showSnackBarMessage(
    ...
    try {
      ...
      print("SnackBar closed with reason: $message");
      ...
      // Print the reason for SnackBar closure
      print("SnackBar closed with reason: $snackBarClosedReason");

      if (SnackBarClosedReason.values.contains(snackBarClosedReason)) {
        onClose?.call();
      }
    } catch (e) {
      // If there's an error in showing the SnackBar, print the error
      print("Error showing SnackBar: $e");
      HelperUtils.showSnackBarMessage(
        context,
        "An error occurred while displaying the message.",
      );
    }
  }
